...
@section('body')
    ...
    <form action="{{ route('tambah_sub_kriteria', $kriteria->id) }}" method="POST">
        ...
        <div class="mb-3 col-5">
          ...
          <input type="text"
            class="form-control form-control-sm" name="kode_sub_kriteria" id="kode_sub_kriteria" aria-describedby="helpId" placeholder="{{ $kriteria->kode }}" value="{{ Session::get('kode_sub_riteria') }}" readonly>
